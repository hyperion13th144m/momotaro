...
### 検索など
PCのブラウザからUbuntuのIPアドレスにアクセする。URL は [http://localhost](http://localhost/)
...
## 注意事項
 ...
 - WSL で起動しているので, 特別な設定しない限り WSL のPCからのみしか接続できません。
...
## Contact
 動作しない、などあったら GitHub Issue までどうぞ。
 (Github Issue 使ったことがないけど）
